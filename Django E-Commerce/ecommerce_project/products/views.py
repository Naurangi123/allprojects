...
from .forms import ProductForm,CategaryFrom,ReviewForm
...
def add_product(request):
    ...
    if request.method=='POST':
        ...
        c_form=CategaryFrom(request.POST)
        if p_form.is_valid() or c_form.is_valid():
            p_form.save()
            c_form.save()
        ...
        p_form=ProductForm()
        c_form=CategaryFrom()
    return render(request,'products/add_product.html',{'p_form':p_form,'c_form':c_form})
